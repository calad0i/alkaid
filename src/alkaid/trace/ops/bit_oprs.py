...
from ..fixed_variable import FVariable, _binary_bit_op, _unary_bit_op

T = TypeVar('T', FVariable, float)


@overload
def binary_bit_op(a: FVariable, b: FVariable, op: int, *args, **kwargs) -> FVariable: ...
